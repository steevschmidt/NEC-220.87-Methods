...
function openPrintablePage() {
    ...
    printWindow.document.write(`
        ...
        <body>
            ...
            <div class="footer">
                <p>Generated by Panel Capacity Calculator ${typeof APP_VERSION !== 'undefined' ? APP_VERSION : 'v?'}, Developed under a grant from the California Energy Commission, on ${new Date().toLocaleDateString()}</p>
